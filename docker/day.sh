...
--name dnas_tmp \
dnas:latest \
/opt/pypy3.8-v7.3.7-aarch64/bin/pypy3 /opt/dnas/scripts/parse_mrts.py --update --remove --enabled --ymd "$1"
...
--name dnas_tmp \
dnas:latest \
/opt/pypy3.8-v7.3.7-aarch64/bin/pypy3 /opt/dnas/scripts/stats.py --update --enabled --daily --ymd "$1"
...
--name dnas_tmp \
dnas:latest \
/opt/pypy3.8-v7.3.7-aarch64/bin/pypy3 /opt/dnas/scripts/git_reports.py --generate --publish --ymd "$1"
...
--name dnas_tmp \
dnas:latest \
/opt/pypy3.8-v7.3.7-aarch64/bin/pypy3 /opt/dnas/scripts/tweet.py --generate --tweet --ymd "$1"
