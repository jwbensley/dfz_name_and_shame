...
class test_mrt_splitter(unittest.TestCase):
    ...
    def test_init(self):
        ...
        with self.assertRaises(FileNotFoundError):
            mrt_splitter("PewjWxSQavM7tCQbXIZlgcK9zXfr1H", False)

        splitter = mrt_splitter(self.bz2_filename, False)
        ...
        splitter = mrt_splitter(self.gz_filename, False)
        self.assertTrue(isinstance(splitter, mrt_splitter))
        self.assertTrue(isinstance(splitter.debug, bool))
        self.assertEqual(splitter.data, None)
        ...
        splitter = mrt_splitter(self.bin_filename, False)
        self.assertTrue(isinstance(splitter, mrt_splitter))
        self.assertTrue(isinstance(splitter.debug, bool))
        self.assertEqual(splitter.data, None)
