...
class test_mrt_parser(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.json_3_path = os.path.join(
            os.path.dirname(os.path.realpath(__file__)), self.json_3_fn
        )
    ...
    def test_parse_upd_dump(self):
        ...
        self.assertEqual(upd_1_stats.bogon_origin_asns[0].filename, self.upd_1_mrt)
        self.assertEqual(upd_1_stats.bogon_origin_asns[0].next_hop, "27.111.228.145")
        self.assertEqual(upd_1_stats.bogon_origin_asns[0].origin_asns, set(["65551"]))
        self.assertEqual(upd_1_stats.bogon_origin_asns[0].peer_asn, "137409")
        self.assertEqual(upd_1_stats.bogon_origin_asns[0].prefix, "103.109.236.0/24")
        self.assertEqual(upd_1_stats.bogon_origin_asns[0].timestamp, "20220421.0200")
        ...
        self.assertEqual(upd_2_stats.bogon_prefixes[0].as_path, ["133210", "6939"])
        self.assertEqual(upd_2_stats.bogon_prefixes[0].comm_set, [])
        self.assertEqual(upd_2_stats.bogon_prefixes[0].filename, self.upd_2_mrt)
        self.assertEqual(upd_2_stats.bogon_prefixes[0].next_hop, "27.111.228.81")
        self.assertEqual(upd_2_stats.bogon_prefixes[0].origin_asns, set(["6939"]))
        self.assertEqual(upd_2_stats.bogon_prefixes[0].peer_asn, "133210")
        self.assertEqual(upd_2_stats.bogon_prefixes[0].prefix, "192.88.99.0/24")
        self.assertEqual(upd_2_stats.bogon_prefixes[0].timestamp, "20220501.2309")
        ...
        self.assertEqual(upd_2_stats.longest_as_path[0].comm_set,["13538:3000"])
        self.assertEqual(upd_2_stats.longest_as_path[0].filename, self.upd_2_mrt)
        self.assertEqual(
            upd_2_stats.longest_as_path[0].next_hop,
            ["2001:de8:4::1:8106:1", "fe80::bac2:53ff:fedb:2004"]
        )
        self.assertEqual(upd_2_stats.longest_as_path[0].origin_asns, set(["264228"]))
        self.assertEqual(upd_2_stats.longest_as_path[0].peer_asn, "18106")
        self.assertEqual(upd_2_stats.longest_as_path[0].prefix, "2804:2488::/48")
        self.assertEqual(upd_2_stats.longest_as_path[0].timestamp, "20220501.2305")
        ...
        self.assertEqual(upd_2_stats.longest_comm_set[0].filename, self.upd_2_mrt)
        self.assertEqual(
            upd_2_stats.longest_comm_set[0].next_hop,
            ["2001:de8:4::1:8106:1", "fe80::bac2:53ff:fedb:2004"]
        )
        self.assertEqual(upd_2_stats.longest_comm_set[0].origin_asns, set(["268267"]))
        self.assertEqual(upd_2_stats.longest_comm_set[0].peer_asn, "18106")
        self.assertEqual(upd_2_stats.longest_comm_set[0].prefix, "2804:4e88::/34")
        self.assertEqual(upd_2_stats.longest_comm_set[0].timestamp, "20220501.2305")
        ...
        self.assertEqual(upd_2_stats.longest_comm_set[1].filename, self.upd_2_mrt)
        self.assertEqual(
            upd_2_stats.longest_comm_set[1].next_hop,
            ["2001:de8:4::1:8106:1", "fe80::bac2:53ff:fedb:2004"]
        )
        self.assertEqual(upd_2_stats.longest_comm_set[1].origin_asns, set(["270793"]))
        self.assertEqual(upd_2_stats.longest_comm_set[1].peer_asn, "18106")
        self.assertEqual(upd_2_stats.longest_comm_set[1].prefix, "2804:7180:100::/40")
        self.assertEqual(upd_2_stats.longest_comm_set[1].timestamp, "20220501.2305")
        ...
        self.assertEqual(upd_2_stats.longest_comm_set[2].filename, self.upd_2_mrt)
        self.assertEqual(
            upd_2_stats.longest_comm_set[2].next_hop,
            ["2001:de8:4::1:8106:1", "fe80::bac2:53ff:fedb:2004"]
        )
        self.assertEqual(upd_2_stats.longest_comm_set[2].origin_asns, set(["270793"]))
        self.assertEqual(upd_2_stats.longest_comm_set[2].peer_asn, "18106")
        self.assertEqual(upd_2_stats.longest_comm_set[2].prefix, "2804:7180::/40")
        self.assertEqual(upd_2_stats.longest_comm_set[2].timestamp, "20220501.2305")
        ...
        self.assertEqual(upd_2_stats.longest_comm_set[3].filename, self.upd_2_mrt)
        self.assertEqual(
            upd_2_stats.longest_comm_set[3].next_hop,
            ["2001:de8:4::1:8106:1", "fe80::bac2:53ff:fedb:2004"]
        )
        self.assertEqual(upd_2_stats.longest_comm_set[3].origin_asns, set(["268182"]))
        self.assertEqual(upd_2_stats.longest_comm_set[3].peer_asn, "18106")
        self.assertEqual(upd_2_stats.longest_comm_set[3].prefix, "2804:5950::/33")
        self.assertEqual(upd_2_stats.longest_comm_set[3].timestamp, "20220501.2305")
        ...
        self.assertEqual(upd_1_stats.invalid_len[0].as_path, ["199524", "38082"])
        self.assertEqual(upd_1_stats.invalid_len[0].comm_set, [])
        self.assertEqual(upd_1_stats.invalid_len[0].filename, self.upd_1_mrt)
        self.assertEqual(upd_1_stats.invalid_len[0].next_hop, ["2001:de8:4::19:9524:1"])
        self.assertEqual(upd_1_stats.invalid_len[0].origin_asns, set(["38082"]))
        self.assertEqual(upd_1_stats.invalid_len[0].peer_asn, "199524")
        self.assertEqual(upd_1_stats.invalid_len[0].prefix, "2405:4000:800:8::/64")
        ...
        self.assertEqual(upd_1_stats.invalid_len[1].origin_asns, set(["23736"]))
        self.assertEqual(upd_1_stats.invalid_len[1].peer_asn, "133210")
        self.assertEqual(upd_1_stats.invalid_len[1].prefix, "2400:7400:0:105::/64")
        ...
        self.assertEqual(upd_1_stats.invalid_len[2].origin_asns, set(["23736"]))
        self.assertEqual(upd_1_stats.invalid_len[2].peer_asn, "133210")
        self.assertEqual(upd_1_stats.invalid_len[2].prefix, "2400:7400:0:106::/64")
        ...
        self.assertEqual(upd_1_stats.invalid_len[3].origin_asns, set(["136168"]))
        ...
        self.assertEqual(
            upd_1_stats.invalid_len[4].as_path, ["133210", "59318", "59318", "15133"]
        )
        self.assertEqual(
            upd_1_stats.invalid_len[4].comm_set,
        ...
        self.assertEqual(upd_1_stats.invalid_len[4].origin_asns, set(["15133"]))
        self.assertEqual(upd_1_stats.invalid_len[4].peer_asn, "133210")
        self.assertEqual(upd_1_stats.invalid_len[4].prefix, "2404:b300:33:1::/64")
        ...
        self.assertEqual(upd_1_stats.invalid_len[5].origin_asns, set(["136168"]))
        self.assertEqual(upd_1_stats.invalid_len[5].peer_asn, "136168")
        self.assertEqual(upd_1_stats.invalid_len[5].prefix, "123.253.228.188/30")
        ...
        self.assertEqual(upd_2_stats.most_advt_prefixes[0].filename, self.upd_2_mrt)
        self.assertEqual(upd_2_stats.most_advt_prefixes[0].next_hop, None)
        self.assertEqual(upd_2_stats.most_advt_prefixes[0].origin_asns, set())
        self.assertEqual(upd_2_stats.most_advt_prefixes[0].peer_asn, None)
        self.assertEqual(upd_2_stats.most_advt_prefixes[0].prefix, "89.30.150.0/23")
        self.assertEqual(upd_2_stats.most_advt_prefixes[0].timestamp, "20220501.2305")
        ...
        self.assertEqual(upd_2_stats.most_upd_prefixes[0].filename, self.upd_2_mrt)
        self.assertEqual(upd_2_stats.most_upd_prefixes[0].next_hop, None)
        self.assertEqual(upd_2_stats.most_upd_prefixes[0].origin_asns, set())
        self.assertEqual(upd_2_stats.most_upd_prefixes[0].peer_asn, None)
        self.assertEqual(upd_2_stats.most_upd_prefixes[0].prefix, "89.30.150.0/23")
        self.assertEqual(upd_2_stats.most_upd_prefixes[0].timestamp, "20220501.2305")
        ...
        self.assertEqual(upd_2_stats.most_withd_prefixes[0].filename, self.upd_2_mrt)
        self.assertEqual(upd_2_stats.most_withd_prefixes[0].next_hop, None)
        self.assertEqual(upd_2_stats.most_withd_prefixes[0].origin_asns, set())
        self.assertEqual(upd_2_stats.most_withd_prefixes[0].peer_asn, None)
        self.assertEqual(
        ...
        self.assertEqual(upd_2_stats.most_advt_origin_asn[0].filename, self.upd_2_mrt)
        self.assertEqual(upd_2_stats.most_advt_origin_asn[0].next_hop, None)
        self.assertEqual(
            upd_2_stats.most_advt_origin_asn[0].origin_asns, set(["20473"])
        )
        self.assertEqual(upd_2_stats.most_advt_origin_asn[0].peer_asn, None)
        self.assertEqual(upd_2_stats.most_advt_origin_asn[0].prefix, None)
        self.assertEqual(
        ...
        self.assertEqual(upd_2_stats.most_advt_peer_asn[0].filename, self.upd_2_mrt)
        self.assertEqual(upd_2_stats.most_advt_peer_asn[0].next_hop, None)
        ...
        self.assertEqual(upd_2_stats.most_advt_peer_asn[0].prefix, None)
        self.assertEqual(upd_2_stats.most_advt_peer_asn[0].timestamp, "20220501.2305")
        ...
        self.assertEqual(upd_2_stats.most_upd_peer_asn[0].filename, self.upd_2_mrt)
        self.assertEqual(upd_2_stats.most_upd_peer_asn[0].next_hop, None)
        ...
        self.assertEqual(upd_2_stats.most_upd_peer_asn[0].prefix, None)
        self.assertEqual(upd_2_stats.most_upd_peer_asn[0].timestamp, "20220501.2305")
        ...
        self.assertEqual(upd_2_stats.most_withd_peer_asn[0].filename, self.upd_2_mrt)
        self.assertEqual(upd_2_stats.most_withd_peer_asn[0].next_hop, None)
        ...
        self.assertEqual(upd_2_stats.most_withd_peer_asn[0].prefix, None)
        self.assertEqual(
        ...
        self.assertEqual(upd_2_stats.most_origin_asns[0].filename, self.upd_2_mrt)
        self.assertEqual(upd_2_stats.most_origin_asns[0].next_hop, None)
        self.assertEqual(
            upd_2_stats.most_origin_asns[0].origin_asns, set(["28198", "262375"])
        )
        self.assertEqual(upd_2_stats.most_origin_asns[0].peer_asn, None)
        self.assertEqual(upd_2_stats.most_origin_asns[0].prefix, "177.131.0.0/21")
        self.assertEqual(upd_2_stats.most_origin_asns[0].timestamp, "20220501.2305")
        ...
        self.assertEqual(upd_2_stats.most_origin_asns[1].filename, self.upd_2_mrt)
        self.assertEqual(upd_2_stats.most_origin_asns[1].next_hop, None)
        self.assertEqual(
            upd_2_stats.most_origin_asns[1].origin_asns, set(["271204", "266181"])
        )
        self.assertEqual(upd_2_stats.most_origin_asns[1].peer_asn, None)
        self.assertEqual(upd_2_stats.most_origin_asns[1].prefix, "179.49.190.0/23")
        self.assertEqual(upd_2_stats.most_origin_asns[1].timestamp, "20220501.2305")
        ...
        self.assertEqual(upd_2_stats.most_origin_asns[2].filename, self.upd_2_mrt)
        self.assertEqual(upd_2_stats.most_origin_asns[2].next_hop, None)
        self.assertEqual(
            upd_2_stats.most_origin_asns[2].origin_asns, set(["396559", "396542"])
        )
        self.assertEqual(upd_2_stats.most_origin_asns[2].peer_asn, None)
        self.assertEqual(upd_2_stats.most_origin_asns[2].prefix, "2620:74:2a::/48")
        self.assertEqual(upd_2_stats.most_origin_asns[2].timestamp, "20220501.2305")
        ...
        self.assertEqual(upd_2_stats.most_origin_asns[3].filename, self.upd_2_mrt)
        self.assertEqual(upd_2_stats.most_origin_asns[3].next_hop, None)
        self.assertEqual(
            upd_2_stats.most_origin_asns[3].origin_asns, set(["7420", "37154"])
        )
        self.assertEqual(upd_2_stats.most_origin_asns[3].peer_asn, None)
        self.assertEqual(upd_2_stats.most_origin_asns[3].prefix, "196.46.192.0/19")
        self.assertEqual(upd_2_stats.most_origin_asns[3].timestamp, "20220501.2305")
        ...
        self.assertEqual(upd_2_stats.most_origin_asns[4].filename, self.upd_2_mrt)
        self.assertEqual(upd_2_stats.most_origin_asns[4].next_hop, None)
        self.assertEqual(
            upd_2_stats.most_origin_asns[4].origin_asns, set(["7487", "54396"])
        )
        self.assertEqual(upd_2_stats.most_origin_asns[4].peer_asn, None)
        self.assertEqual(upd_2_stats.most_origin_asns[4].prefix, "205.197.192.0/21")
        self.assertEqual(upd_2_stats.most_origin_asns[4].timestamp, "20220501.2305")
        ...
        self.assertEqual(upd_2_stats.most_origin_asns[5].filename, self.upd_2_mrt)
        self.assertEqual(upd_2_stats.most_origin_asns[5].next_hop, None)
        self.assertEqual(
            upd_2_stats.most_origin_asns[5].origin_asns, set(["203020", "29802"])
        )
        self.assertEqual(upd_2_stats.most_origin_asns[5].peer_asn, None)
        self.assertEqual(upd_2_stats.most_origin_asns[5].prefix, "206.123.159.0/24")
        self.assertEqual(upd_2_stats.most_origin_asns[5].timestamp, "20220501.2305")
        ...
        self.assertEqual(upd_2_stats.most_origin_asns[6].filename, self.upd_2_mrt)
        self.assertEqual(upd_2_stats.most_origin_asns[6].next_hop, None)
        self.assertEqual(
            upd_2_stats.most_origin_asns[6].origin_asns, set(["52000", "19318"])
        )
        self.assertEqual(upd_2_stats.most_origin_asns[6].peer_asn, None)
        self.assertEqual(upd_2_stats.most_origin_asns[6].prefix, "68.168.210.0/24")
        self.assertEqual(upd_2_stats.most_origin_asns[6].timestamp, "20220501.2305")
        ...
        self.assertEqual(upd_2_stats.most_origin_asns[7].filename, self.upd_2_mrt)
        self.assertEqual(upd_2_stats.most_origin_asns[7].next_hop, None)
        self.assertEqual(
            upd_2_stats.most_origin_asns[7].origin_asns, set(["55020", "137951"])
        )
        self.assertEqual(upd_2_stats.most_origin_asns[7].peer_asn, None)
        self.assertEqual(upd_2_stats.most_origin_asns[7].prefix, "156.241.128.0/22")
        self.assertEqual(upd_2_stats.most_origin_asns[7].timestamp, "20220501.2305")
        ...
        self.assertEqual(upd_2_stats.most_origin_asns[8].filename, self.upd_2_mrt)
        self.assertEqual(upd_2_stats.most_origin_asns[8].next_hop, None)
        self.assertEqual(
            upd_2_stats.most_origin_asns[8].origin_asns, set(["269208", "268347"])
        )
        self.assertEqual(upd_2_stats.most_origin_asns[8].peer_asn, None)
        self.assertEqual(upd_2_stats.most_origin_asns[8].prefix, "2804:610c::/32")
