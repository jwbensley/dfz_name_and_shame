...
class test_mrt_stats(unittest.TestCase):
    ...
    def test_init(self):
        ...
        self.assertIsInstance(mrt_s.bogon_origin_asns[0], mrt_entry)
        self.assertIsInstance(mrt_s.bogon_prefixes, list)
        self.assertIsInstance(mrt_s.bogon_prefixes[0], mrt_entry)
        self.assertIsInstance(mrt_s.longest_as_path, list)
        self.assertIsInstance(mrt_s.longest_as_path[0], mrt_entry)
        self.assertIsInstance(mrt_s.longest_comm_set, list)
        self.assertIsInstance(mrt_s.longest_comm_set[0], mrt_entry)
        self.assertIsInstance(mrt_s.invalid_len, list)
        self.assertIsInstance(mrt_s.invalid_len[0], mrt_entry)
        self.assertIsInstance(mrt_s.most_advt_prefixes, list)
        self.assertIsInstance(mrt_s.most_advt_prefixes[0], mrt_entry)
        self.assertIsInstance(mrt_s.most_upd_prefixes, list)
        self.assertIsInstance(mrt_s.most_upd_prefixes[0], mrt_entry)
        self.assertIsInstance(mrt_s.most_withd_prefixes, list)
        self.assertIsInstance(mrt_s.most_withd_prefixes[0], mrt_entry)
        self.assertIsInstance(mrt_s.most_advt_origin_asn, list)
        self.assertIsInstance(mrt_s.most_advt_origin_asn[0], mrt_entry)
        self.assertIsInstance(mrt_s.most_advt_peer_asn, list)
        self.assertIsInstance(mrt_s.most_advt_peer_asn[0], mrt_entry)
        self.assertIsInstance(mrt_s.most_upd_peer_asn, list)
        self.assertIsInstance(mrt_s.most_upd_peer_asn[0], mrt_entry)
        self.assertIsInstance(mrt_s.most_withd_peer_asn, list)
        self.assertIsInstance(mrt_s.most_withd_peer_asn[0], mrt_entry)
        self.assertIsInstance(mrt_s.most_origin_asns, list)
        self.assertIsInstance(mrt_s.most_origin_asns[0], mrt_entry)
    ...
    def test_get_diff(self):
        ...
        self.assertEqual(diff.bogon_origin_asns[0].advt, 0)
        self.assertEqual(diff.bogon_origin_asns[0].as_path, [[]])
        self.assertEqual(diff.bogon_origin_asns[0].comm_set, [[]])
        self.assertEqual(diff.bogon_origin_asns[0].filename, None)
        self.assertEqual(diff.bogon_origin_asns[0].next_hop, None)
        self.assertEqual(diff.bogon_origin_asns[0].origin_asns, set([]))
        self.assertEqual(diff.bogon_origin_asns[0].peer_asn, None)
        self.assertEqual(diff.bogon_origin_asns[0].prefix, None)
        self.assertEqual(diff.bogon_origin_asns[0].timestamp, None)
        self.assertEqual(diff.bogon_origin_asns[0].updates, 0)
        self.assertEqual(diff.bogon_origin_asns[0].withdraws, 0)
