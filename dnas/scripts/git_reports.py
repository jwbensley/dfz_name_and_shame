...
def generate_range(end: str, start: str) -> None:
    """
...
def publish_range(end: str, start: str) -> None:
    """
...
def main():
    ...
    if args["generate"]:
        if args["ymd"]:
            ...
            raise ValueError("--range or --ymd must be used with --generate!")
    ...
    if args["publish"]:
        if args["ymd"]:
            ...
            raise ValueError("--range or --ymd must be used with --publish!")
